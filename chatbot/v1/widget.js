  ...
  function buildHTML() {
    ...
    var brd = SHOW_BRANDING
      ? '<div id="vnbrd" class="vntp" data-panel="branding" style="padding:14px;overflow-y:auto">'
        ...
        + '<div class="vnbrsz" data-size="56" style="flex:1;display:flex;align-items:center;justify-content:center;height:84px;border-radius:10px;border:2px solid #d1d5db;background:#fafbfc;cursor:pointer;transition:all .2s;opacity:0.5">' + flagSvg(56) + '</div>'
        + '<div class="vnbrsz" data-size="58" style="flex:1;display:flex;align-items:center;justify-content:center;height:84px;border-radius:10px;border:2px solid #d1d5db;background:#fafbfc;cursor:pointer;transition:all .2s;opacity:0.5">' + flagSvg(58) + '</div>'
        + '<div class="vnbrsz" data-size="60" style="flex:1;display:flex;align-items:center;justify-content:center;height:84px;border-radius:10px;border:2px solid #d1d5db;background:#fafbfc;cursor:pointer;transition:all .2s;opacity:0.5">' + flagSvg(60) + '</div>'
        + '</div>'
