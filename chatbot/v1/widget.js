...
(function () {
  ...
  function buildHTML() {
    ...
    return '<style id="vns">' + CSS + '</style>'
      ...
      + '<svg class="vnfab-flag" viewBox="0 0 62 62"><defs><clipPath id="vnfcp"><path d="M8 6h44a4 4 0 014 4v28a4 4 0 01-4 4H20l-8 10V42H8a4 4 0 01-4-4V10a4 4 0 014-4z"/></clipPath></defs><path d="M8 6h44a4 4 0 014 4v28a4 4 0 01-4 4H20l-8 10V42H8a4 4 0 01-4-4V10a4 4 0 014-4z" fill="#fff" stroke="rgba(0,0,0,.08)" stroke-width=".5"/><g clip-path="url(#vnfcp)"><rect x="4" y="6" width="52" height="36" fill="#B22234"/><rect x="4" y="8.77" width="52" height="2.77" fill="#fff"/><rect x="4" y="14.31" width="52" height="2.77" fill="#fff"/><rect x="4" y="19.85" width="52" height="2.77" fill="#fff"/><rect x="4" y="25.38" width="52" height="2.77" fill="#fff"/><rect x="4" y="30.92" width="52" height="2.77" fill="#fff"/><rect x="4" y="36.46" width="52" height="2.77" fill="#fff"/><rect x="4" y="6" width="21" height="19.39" fill="#1a3a6b"/><circle cx="5.2" cy="7.2" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="9.85" cy="7.2" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="14.5" cy="7.2" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="19.15" cy="7.2" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="23.8" cy="7.2" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="7.53" cy="10.03" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="12.18" cy="10.03" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="16.83" cy="10.03" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="21.48" cy="10.03" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="5.2" cy="12.86" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="9.85" cy="12.86" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="14.5" cy="12.86" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="19.15" cy="12.86" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="23.8" cy="12.86" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="7.53" cy="15.69" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="12.18" cy="15.69" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="16.83" cy="15.69" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="21.48" cy="15.69" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="5.2" cy="18.52" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="9.85" cy="18.52" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="14.5" cy="18.52" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="19.15" cy="18.52" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="23.8" cy="18.52" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="7.53" cy="21.35" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="12.18" cy="21.35" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="16.83" cy="21.35" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="21.48" cy="21.35" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="5.2" cy="24.18" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="9.85" cy="24.18" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="14.5" cy="24.18" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="19.15" cy="24.18" r=".9" fill="rgba(255,255,255,.9)"/><circle cx="23.8" cy="24.18" r=".9" fill="rgba(255,255,255,.9)"/></g><ellipse cx="22" cy="13" rx="16" ry="7" fill="rgba(255,255,255,.15)" transform="rotate(-10 22 13)"/></svg>'
      + '</button>'
