...
(function () {
  ...
  var NODES = {
    ...
    voc_rehab_apply: {
      pct: 76,
      bot: "<strong>How to apply for Vocational Rehabilitation (VR&E):</strong>\n\n<strong>Step 1</strong> — Apply online at <a href='https://va.gov/careers-employment/vocational-rehabilitation/how-to-apply' target='_blank' rel='noopener noreferrer' style='color:var(--gold);text-decoration:underline;text-underline-offset:2px;'>VA.gov</a>\n<strong>Step 2</strong> — VA reviews your eligibility (disability rating + employment barrier)\n<strong>Step 3</strong> — Meet with a VR&E counselor to assess your needs\n<strong>Step 4</strong> — Together, you create a personalized rehabilitation plan\n<strong>Step 5</strong> — Begin your program (school, training, or job placement)\n\n<strong>Documents you'll need:</strong>\n— DD-214 or statement of service\n— VA disability rating letter\n— Resume or work history (if available)\n\n<strong>Timeline:</strong> Eligibility determination typically takes <strong>2–4 weeks</strong>. Your first counselor meeting is usually scheduled within 30 days of approval.\n\n<strong>Tip:</strong> You can use VR&E and GI Bill benefits — but not at the same time. A VR&E counselor can help you decide which is better for your situation.",
    ...
    tdiu: {
      pct: 62,
      bot: "<strong>TDIU — Total Disability Based on Individual Unemployability</strong>\n\nIf your service-connected disabilities prevent you from holding a steady job, you may qualify for <strong>compensation at the 100% rate — even with a lower rating</strong>.\n\n<strong>Who qualifies:</strong>\n— One condition rated 60%+, OR\n— Multiple conditions totaling 70%+ (with at least one at 40%+)\n— Unable to maintain substantially gainful employment\n\n<strong>2026 rate:</strong> $3,939/month (same as 100% schedular)\n\n<strong>How to apply:</strong>\n— Complete <a href='https://va.gov/find-forms/about-form-21-8940' target='_blank' rel='noopener noreferrer' style='color:var(--gold);text-decoration:underline;text-underline-offset:2px;'>VA Form 21-8940</a> (Veteran's Application for Increased Compensation Based on Unemployability)\n— Your employer may also need to complete VA Form 21-4192\n— Submit with medical evidence showing your disabilities prevent employment\n\n<strong>Timeline:</strong> TDIU claims typically take <strong>3–5 months</strong> to process.\n\n<strong>Tip:</strong> Many Veterans qualify but don't know about TDIU. A VSO counselor can assess your eligibility and help build the strongest case.\n\n<em style='font-size:11px;color:rgba(255,255,255,0.4);'>Rate effective Dec 2025 (2.8% COLA). Verify at <a href='https://va.gov/disability/compensation-rates' target='_blank' rel='noopener noreferrer' style='color:rgba(232,200,74,0.6);'>VA.gov</a>.</em>",
    ...
    pension_apply: {
      pct: 65,
      bot: "<strong>How to apply for VA Pension:</strong>\n\n<strong>Step 1</strong> — Apply online at <a href='https://va.gov/pension/application/527EZ/introduction' target='_blank' rel='noopener noreferrer' style='color:var(--gold);text-decoration:underline;text-underline-offset:2px;'>VA.gov</a> using VA Form 21P-527EZ\n<strong>Step 2</strong> — VA verifies your military service (wartime dates confirmed against DD-214)\n<strong>Step 3</strong> — VA reviews your income and net worth against current limits\n<strong>Step 4</strong> — VA issues a rating decision — approval or request for more info\n<strong>Step 5</strong> — If approved, payments begin retroactive to your application date\n\n<strong>Documents you'll need:</strong>\n— DD-214 (discharge papers)\n— Marriage certificate (if applying with spouse)\n— Financial records: income, bank accounts, property (non-home assets)\n— Medical records if applying based on permanent disability (under age 65)\n— Caregiver or nursing home documentation if requesting Aid & Attendance\n\n<strong>Timeline:</strong> VA Pension decisions typically take <strong>3–6 months</strong>. Complex cases (A&A, multiple dependents) may take longer.\n\n<strong>Tip:</strong> A free VSO counselor can prepare and submit your entire application — strongly recommended. Net worth calculations and medical documentation requirements are easy to get wrong on your own.\n\n<em style='font-size:11px;color:rgba(255,255,255,0.4);'>This is general information only — not legal or financial advice.</em>",
      chips: ['What is VA Pension?', 'What is Aid & Attendance?', 'Find a VSO counselor', 'See other benefits']
    },

    aid_attendance: {
      pct: 55,
      bot: "<strong>Aid & Attendance (A&A) — Enhanced VA Pension:</strong>\n\nA higher pension payment for veterans (or surviving spouses) who need help with daily activities due to age, illness, or disability.\n\n<strong>You may qualify if you:</strong>\n— Need help with bathing, dressing, eating, or using the bathroom\n— Are bedridden or in a nursing home or assisted living facility\n— Have severe vision loss (corrected vision 5/200 or less)\n\n<strong>2026 maximum rates with A&A:</strong>\n— Veteran alone: $29,093/yr ($2,424/mo)\n— Veteran with spouse: $34,488/yr ($2,874/mo)\n— Surviving spouse: ~$22,304/yr (~$1,858/mo)\n\n<strong>Net worth limit:</strong> $163,699 (includes assets + income)\n\n<strong>How to apply:</strong>\n— <strong>Step 1:</strong> Apply for VA Pension first (VA Form 21P-527EZ) — A&A is an add-on\n— <strong>Step 2:</strong> Get VA Form 21-2680 (Examination for Housebound Status or Permanent Need for Regular Aid and Attendance) completed by your doctor\n— <strong>Step 3:</strong> Submit both forms together — online at <a href='https://va.gov/pension/application/527EZ/introduction' target='_blank' rel='noopener noreferrer' style='color:var(--gold);text-decoration:underline;text-underline-offset:2px;'>VA.gov</a> or by mail\n\n<strong>Documents needed:</strong>\n— DD-214, financial records, VA Form 21-2680 (physician's report)\n— Nursing home or care facility documentation (if applicable)\n\n<strong>Timeline:</strong> 3–6 months. Start early — payments are retroactive to your application date.\n\n<strong>Important:</strong> This benefit is significantly underused. Many elderly veterans in care facilities qualify but have never applied.\n\n<em style='font-size:11px;color:rgba(255,255,255,0.4);'>Rates effective Dec 2025 (2.8% COLA). Verify at <a href='https://va.gov/pension/veterans-pension-rates' target='_blank' rel='noopener noreferrer' style='color:rgba(232,200,74,0.6);'>VA.gov</a>. This is general information only — not legal or financial advice.</em>",
    ...
    adapted_housing: {
      pct: 55,
      bot: "<strong>VA Adapted Housing Grants</strong> — financial help to make your home accessible.\n\n<strong>Three grant programs:</strong>\n\n<strong>SAH (Specially Adapted Housing)</strong> — up to $109,986\nFor Veterans with severe service-connected disabilities (loss of limbs, blindness, severe burns). Build a new adapted home or modify an existing one.\n\n<strong>SHA (Special Housing Adaptation)</strong> — up to $22,036\nFor Veterans with specific disabilities like blindness or loss of hands. Modify an existing home.\n\n<strong>TRA (Temporary Residence Adaptation)</strong> — up to $46,496\nFor Veterans temporarily living in a family member's home that needs modifications.\n\n<strong>Who qualifies:</strong>\n— Must have a qualifying service-connected disability\n— Must own or plan to own the home\n— Grant can be used up to 3 times (lifetime total not to exceed max)\n\n<strong>How to apply:</strong>\n— Apply online at <a href='https://va.gov/housing-assistance/disability-housing-grants' target='_blank' rel='noopener noreferrer' style='color:var(--gold);text-decoration:underline;text-underline-offset:2px;'>VA.gov</a>\n— Or call <a href='tel:+18008271000' style='color:var(--gold);text-decoration:underline;text-underline-offset:2px;'>1-800-827-1000</a>\n— Complete VA Form 26-4555\n\n<strong>Timeline:</strong> Grant approval typically takes <strong>2–4 months</strong>. A VA Specially Adapted Housing agent will be assigned to guide you through the process.\n\n<strong>Examples:</strong> Wheelchair ramps, roll-in showers, widened doorways, stair lifts, accessible kitchens.",
  ...
  var CHIP_MAP = {
    ...
    'What happens after I file?':'claim_status',
    ...
    'How do I apply for VA Pension?':'pension_apply',
  ...
  // ── CSS ────────────────────────────────────────────────────────────────────
  var CSS = [
    ':root{--vr:#cc3344;--vrd:#a82535;--vn:#0f172a;--vg:#e8c84a;',
    '--vbg:#ffffff;--vbd:rgba(0,0,0,.06);',
    '--vt:#1e293b;--vs:#64748b;',
    ...
    'background:#fff;border:.5px solid rgba(0,0,0,.08);border-radius:18px;',
    ...
    // Header — faded rose
    '#vnh{background:linear-gradient(135deg,#f5e8e6,#f0dad7);',
    'padding:12px 16px;display:flex;align-items:center;gap:10px;',
    'border-bottom:.5px solid rgba(178,34,52,.08)}',
    ...
    '.vntb.act{color:#0f172a;border-bottom-color:var(--vr)}',
    ...
    // Chat messages — rose→white→blue gradient
    '#vnms{padding:12px 11px;flex:1;min-height:180px;',
    'background:linear-gradient(180deg,#fdf9f8 0%,#fff 25%,#fff 75%,#f4f6fb 100%);',
    'overflow-y:auto;display:flex;flex-direction:column;gap:10px;scroll-behavior:smooth}',
    '#vnms::-webkit-scrollbar{width:2px}',
    '#vnms::-webkit-scrollbar-thumb{background:rgba(0,0,0,.08);border-radius:2px}',
    '.vnr{display:flex;gap:7px;align-items:flex-start}',

    // Bot avatar — lighter red glass rounded-square with water droplet
    '.vnav{width:24px;height:24px;border-radius:6px;flex-shrink:0;',
    'display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700;',
    'position:relative}',
    '.vnav.b{background:linear-gradient(145deg,#e05565,#cc3344 50%,#a82535);color:#fff;',
    'box-shadow:inset 0 1px 2px rgba(255,255,255,.35),inset 0 -1px 1px rgba(0,0,0,.15),0 1px 4px rgba(178,34,52,.2)}',
    '.vnav.b::before{content:"";position:absolute;top:2px;left:3px;width:8px;height:5px;',
    ...
    '.vnbb em{font-style:italic;color:#64748b}',
    ...
    'background:rgba(0,0,0,.15);animation:vnD 1.2s infinite}',
    ...
    'border-color:rgba(204,51,68,.2);',
    'box-shadow:inset 0 1px 3px rgba(255,255,255,.6),inset 0 -2px 4px rgba(204,51,68,.06),0 4px 16px rgba(204,51,68,.12);',
    ...
    '.vnct{font-size:13px;font-weight:600;position:relative;z-index:1;background:linear-gradient(180deg,#1a2744,#3d4a6b);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}',
    ...
    'background:linear-gradient(180deg,#edf0f7,#e4e8f2);border-top:.5px solid rgba(26,58,107,.06)}',
    '#vntx{flex:1;font-size:16px;padding:7px 13px;border-radius:18px;',
    'border:.5px solid rgba(90,143,212,.15);background:rgba(255,255,255,.65);',
    'color:#1e293b;font-family:inherit;outline:none}',
    '#vntx::placeholder{color:#94a3b8}',
    '#vntx:focus{border-color:rgba(90,143,212,.4)}',

    // Send button — water droplet red glass circle
    '#vnsd,#vnmc{width:32px;height:32px;border-radius:50%;border:none;cursor:pointer;',
    'display:flex;align-items:center;justify-content:center;flex-shrink:0;',
    'transition:all .15s;position:relative;overflow:hidden}',
    '#vnsd{background:linear-gradient(145deg,#e05565,#cc3344 40%,#a82535);',
    'box-shadow:0 3px 10px rgba(178,34,52,.35),inset 0 2px 3px rgba(255,255,255,.35),inset 0 -2px 3px rgba(0,0,0,.15)}',
    '#vnsd::before{content:"";position:absolute;top:4px;left:5px;width:12px;height:7px;',
    'background:linear-gradient(180deg,rgba(255,255,255,.45),rgba(255,255,255,0));',
    'border-radius:50%;transform:rotate(-15deg)}',
    '#vnsd:hover{background:linear-gradient(145deg,#e8606f,#d4384a 40%,#b52a3a);',
    'box-shadow:0 4px 14px rgba(178,34,52,.45),inset 0 2px 3px rgba(255,255,255,.35),inset 0 -2px 3px rgba(0,0,0,.15)}',
    '#vnsd svg{width:11px;height:11px;fill:#fff;position:relative;z-index:1;',
    ...
    // Session warning
    '#vnwn{display:none;padding:6px 12px;background:rgba(232,200,74,.08);',
    'border-top:.5px solid rgba(232,200,74,.15);font-size:11px;',
    'color:#8b6914;text-align:center}',

    // Limit screen — light theme
    '#vnlm{display:none;padding:16px;overflow-y:auto;max-height:460px;background:#fff}',
    '#vnlm h3{font-size:15px;font-weight:700;color:#0f172a;margin-bottom:6px}',
    '#vnlm p{font-size:12px;color:#64748b;margin-bottom:12px;line-height:1.5}',
    '#vnlm ul{list-style:none;margin-bottom:14px}',
    '#vnlm ul li{font-size:12px;color:#1e293b;padding:3px 0;',
    ...
    'border:.5px solid rgba(0,0,0,.1);background:#fafafa;',
    'color:#1e293b;font-family:inherit;outline:none}',
    '#vnsem::placeholder{color:#94a3b8}',
    ...
    '#vnset{display:none;font-size:12px;color:#166534;',
    'margin-bottom:10px;text-align:center}',
    '.vnvb{background:#fafafa;border:.5px solid rgba(0,0,0,.06);',
    'border-radius:9px;padding:10px 12px;margin-bottom:10px;',
    'font-size:12px;color:#1e293b;line-height:1.6}',
    '.vnvb strong{color:#0f172a;display:block;margin-bottom:4px}',
    '#vnrs{width:100%;padding:9px;border-radius:9px;',
    'border:.5px solid rgba(0,0,0,.1);background:transparent;',
    'color:#64748b;font-size:12px;font-weight:600;',
    'cursor:pointer;font-family:inherit}',
    '#vnrs:hover{background:rgba(0,0,0,.02)}',
    ...
    '.vnal{font-size:11px;color:#1a3a6b;letter-spacing:1.5px;text-transform:uppercase;margin:8px 0 4px;display:block;font-weight:600}',
    '.vnai{width:100%;background:#fafafa;border:1px solid rgba(0,0,0,.1);border-radius:7px;padding:5px 9px;font-size:12px;color:#1e293b;font-family:inherit;outline:none;box-sizing:border-box;margin-bottom:4px}',
    '.vnai:focus{border-color:rgba(90,143,212,.4)}',
    ...
    'border:.5px solid rgba(0,0,0,.1);background:transparent;',
    'color:#94a3b8;cursor:pointer;font-size:14px;line-height:1;flex-shrink:0}',
    '.vnarm:hover{background:rgba(178,34,52,.06);color:#cc3344}',
    ...
    'border:none;background:rgba(0,0,0,.02);color:#94a3b8;',
    'font-family:inherit;transition:all .15s;text-align:center}',
    '.vnsc.act{background:rgba(90,143,212,.1);color:#1a5fb4}',
  ...
  function buildHTML() {
    ...
    var FAB_SVG_MARKUP = '<svg class="vnfab-flag" viewBox="0 0 62 62"><defs><clipPath id="vnfcp"><path d="M8 6h44a4 4 0 014 4v28a4 4 0 01-4 4H20l-8 10V42H8a4 4 0 01-4-4V10a4 4 0 014-4z"/></clipPath></defs><path d="M8 6h44a4 4 0 014 4v28a4 4 0 01-4 4H20l-8 10V42H8a4 4 0 01-4-4V10a4 4 0 014-4z" fill="#fff" stroke="rgba(0,0,0,.08)" stroke-width=".5"/><g clip-path="url(#vnfcp)"><rect x="4" y="6" width="52" height="4" fill="#B22234"/><rect x="4" y="10" width="52" height="4" fill="#fff"/><rect x="4" y="14" width="52" height="4" fill="#B22234"/><rect x="4" y="18" width="52" height="4" fill="#fff"/><rect x="4" y="22" width="52" height="4" fill="#B22234"/><rect x="4" y="26" width="52" height="4" fill="#fff"/><rect x="4" y="30" width="52" height="4" fill="#B22234"/><rect x="4" y="34" width="52" height="4" fill="#fff"/><rect x="4" y="38" width="52" height="4" fill="#B22234"/><rect x="4" y="42" width="52" height="4" fill="#fff"/><rect x="4" y="46" width="52" height="4" fill="#B22234"/><rect x="4" y="50" width="52" height="4" fill="#fff"/><rect x="4" y="54" width="52" height="4" fill="#B22234"/><rect x="4" y="6" width="24" height="22" fill="#1a3a6b"/><g fill="rgba(255,255,255,.95)"><circle cx="7.5" cy="9" r=".8"/><circle cx="11.5" cy="9" r=".8"/><circle cx="15.5" cy="9" r=".8"/><circle cx="19.5" cy="9" r=".8"/><circle cx="23.5" cy="9" r=".8"/><circle cx="9.5" cy="11.5" r=".8"/><circle cx="13.5" cy="11.5" r=".8"/><circle cx="17.5" cy="11.5" r=".8"/><circle cx="21.5" cy="11.5" r=".8"/><circle cx="7.5" cy="14" r=".8"/><circle cx="11.5" cy="14" r=".8"/><circle cx="15.5" cy="14" r=".8"/><circle cx="19.5" cy="14" r=".8"/><circle cx="23.5" cy="14" r=".8"/><circle cx="9.5" cy="16.5" r=".8"/><circle cx="13.5" cy="16.5" r=".8"/><circle cx="17.5" cy="16.5" r=".8"/><circle cx="21.5" cy="16.5" r=".8"/><circle cx="7.5" cy="19" r=".8"/><circle cx="11.5" cy="19" r=".8"/><circle cx="15.5" cy="19" r=".8"/><circle cx="19.5" cy="19" r=".8"/><circle cx="23.5" cy="19" r=".8"/><circle cx="9.5" cy="21.5" r=".8"/><circle cx="13.5" cy="21.5" r=".8"/><circle cx="17.5" cy="21.5" r=".8"/><circle cx="21.5" cy="21.5" r=".8"/><circle cx="7.5" cy="24" r=".8"/><circle cx="11.5" cy="24" r=".8"/><circle cx="15.5" cy="24" r=".8"/><circle cx="19.5" cy="24" r=".8"/><circle cx="23.5" cy="24" r=".8"/></g></g><ellipse cx="22" cy="13" rx="16" ry="7" fill="rgba(255,255,255,.15)" transform="rotate(-10 22 13)"/></svg>';

    function fabPreview(sz) {
      return FAB_SVG_MARKUP.replace('class="vnfab-flag"', 'class="vnfab-flag" style="width:' + sz + 'px;height:' + sz + 'px"');
    }
    ...
    var brd = SHOW_BRANDING
      ? '<div id="vnbrd" class="vntp" data-panel="branding" style="padding:14px;overflow-y:auto">'
        ...
        + '<div id="vnbrl" style="margin-bottom:6px;display:none"><img id="vnbrli" src="" style="max-height:40px;max-width:100px;object-fit:contain;border-radius:6px;border:1px solid #d1d5db" alt="Current logo"></div>'
        + '<input id="vnbrf" type="file" accept="image/png,image/jpeg,image/gif,image/svg+xml,image/webp" style="display:none">'
        + '<button id="vnbrub" style="width:100%;padding:8px;border-radius:10px;border:1px solid #d1d5db;background:#fafbfc;color:#1e293b;font-size:12px;font-weight:500;cursor:pointer;font-family:inherit;margin-bottom:2px">📁 Choose Logo File</button>'
        + '<div id="vnbrst" style="font-size:10px;min-height:12px;margin-bottom:10px;line-height:1.3"></div>'
        + '<div style="font-size:12px;font-weight:700;margin-bottom:4px;background:linear-gradient(180deg,#1a3a6b,#2d5090);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">Custom Welcome Message</div>'
        ...
        + '<div class="vnbrsz" data-size="56" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;height:84px;padding:8px 4px;border-radius:10px;border:2px solid #d1d5db;background:#fafbfc;cursor:pointer;transition:all .2s;opacity:0.5">' + fabPreview(56) + '<div style="font-size:10px;font-weight:600;color:#64748b">Small</div></div>'
        + '<div class="vnbrsz" data-size="58" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;height:84px;padding:8px 4px;border-radius:10px;border:2px solid #d1d5db;background:#fafbfc;cursor:pointer;transition:all .2s;opacity:0.5">' + fabPreview(58) + '<div style="font-size:10px;font-weight:600;color:#64748b">Default</div></div>'
        + '<div class="vnbrsz" data-size="60" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;height:84px;padding:8px 4px;border-radius:10px;border:2px solid #d1d5db;background:#fafbfc;cursor:pointer;transition:all .2s;opacity:0.5">' + fabPreview(60) + '<div style="font-size:10px;font-weight:600;color:#64748b">Large</div></div>'
        + '</div>'
    ...
    return '<style id="vns">' + CSS + '</style>'
      ...
      + '</button>'
      + '<div id="vnn" style="display:none"><span id="vnnt"></span></div>'
      + '<div id="vnp">'
  ...
  function initBranding() {
    ...
    document.querySelectorAll('.vnbrsz').forEach(function (sz) {
      // Highlight saved size on load
      var size = parseInt(sz.getAttribute('data-size'));
      ...
      if (LICENSE_KEY && LICENSE_KEY.startsWith('VN-') && LICENSE_KEY !== 'VN-DEMO') {
        fetch(VN_API + '/config?key=' + encodeURIComponent(LICENSE_KEY), {
          ...
          body: JSON.stringify({
            ...
            orgFabSize:     String(selectedFabSize || 58)
          })
        }).catch(function () {});
      }
      ge('vnbrsvd').style.display = 'block';
      ge('vnbrsvd').style.color = '#166534';
